...
<form mname="form1" action="login_act.php" method="post">
  <h1 class="a11y-hidden">Login Form</h1>
  <div>
    <label class="label-email">
      <input type="text" class="text" name="lid" placeholder="ID" required />
  ...
  <div>
    <label class="label-password">
      <input type="password" class="text" name="lpw" placeholder="Password" required />
      <span class="required">Password</span>
    </label>
  </div>
  <input type="submit" value="LOGIN" />
  <div class="email">
    <a href="register.php">まだ登録してない方</a>
  </div>
  <!-- <figure aria-hidden="true"> -->
  <figure >
  <div><img src="img/smile.png" alt=""></div>
  </figure>
</form>
